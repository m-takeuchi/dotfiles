  ...
  -- add symbols-outline
  {
    ...
    config = function()
      require("telekasten").setup({
        ...
        template_new_daily = vim.fn.expand("~/zettelkasten/templates/template_daily_note.md"),
        template_new_weekly = vim.fn.expand("~/zettelkasten/templates/template_weekly_note.md"),
        --        vaults = {
        --          personal = {
